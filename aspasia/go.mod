module github.com/odysseia-greek/apologia/aspasia
...
require (
	...
	github.com/odysseia-greek/apologia/diotima v0.0.1-rho5
	github.com/odysseia-greek/attike/aristophanes v0.7.0-rho5

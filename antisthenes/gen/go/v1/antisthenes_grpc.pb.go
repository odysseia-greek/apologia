...
func (c *antisthenesClient) Question(ctx context.Context, in *CreationRequest, opts ...grpc.CallOption) (*QuizResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/antisthenes.v1.Antisthenes/Question", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *antisthenesClient) Answer(ctx context.Context, in *AnswerRequest, opts ...grpc.CallOption) (*AnswerResponse, error) {
	out := new(AnswerResponse)
	err := c.cc.Invoke(ctx, "/antisthenes.v1.Antisthenes/Answer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAntisthenesServer) Answer(context.Context, *AnswerRequest) (*AnswerResponse, error) {
...
func _Antisthenes_Question_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/antisthenes.v1.Antisthenes/Question",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Antisthenes_Answer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/antisthenes.v1.Antisthenes/Answer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Antisthenes_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "antisthenes.v1.Antisthenes",
